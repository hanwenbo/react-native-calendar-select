原库地址：https://github.com/Tinysymphony/react-native-calendar-select


原库rn 0.58.6出现了，xcode运行react-native报错"_OBJC_CLASS_$_RCTBundleURLProvider", referenced from: objc-class-ref 

步骤：1，在终端输入：react-native start
